...
import com.example.instagram_f16.LoginActivity
import com.example.instagram_f16.MainActivity
...
import com.example.instagram_f16.navigation.model.FollowDTO
...
class UserFragment : Fragment(){
    ...
    override  fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?):View? {
        ...
        if(uid == currentUserUid){
            ...
            mainActivity?.my_toolbar_btn_back.setOnClickListener{
                mainActivity.bottom_navigation.selectedItemId = R.id.action_home
            }
            mainActivity?.toolbar_title_image?.visibility = View.GONE
            mainActivity?.toolbar_username.visibility = View.VISIBLE
            mainActivity?.my_toolbar_btn_back.visibility = View.VISIBLE
            fragmentView?.account_btn_follow_signout?.setOnClickListener {
                requestFollow()
            }
        }
    ...
    fun requestFollow(){
        ...
        firestore?.runTransaction { transaction ->
            ...
            if(followDTO == null){
                ...
                followerAlarm(uid!!)    //누군가 팔로우 했을때 알람이벤트 발생
